...
import AgentRegistryArtifact from "../../../contracts/artifacts/contracts/AgentRegistry.sol/AgentRegistry.json" with { type: "json" };
import TaskEscrowArtifact from "../../../contracts/artifacts/contracts/TaskEscrow.sol/TaskEscrow.json" with { type: "json" };
import ReputationOracleArtifact from "../../../contracts/artifacts/contracts/ReputationOracle.sol/ReputationOracle.json" with { type: "json" };
